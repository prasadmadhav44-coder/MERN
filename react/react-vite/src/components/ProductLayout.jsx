            ...
            <section className="bg-gray-50 py-8 antialiased dark:bg-gray-900 md:py-12">
                <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
                    ...
                    <div className="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
                        <ProductCard product_name={"apple"} offer={30}/>
                        <ProductCard product_name={"apple1"} />
                        <ProductCard product_name={"apple2"} />
                        <ProductCard product_name={"apple3"} />
                        <ProductCard product_name={"apple4"} />
                        <ProductCard product_name={"apple5"} />
                        <ProductCard product_name={"apple6"} />
                        <ProductCard product_name={"apple7"} />
                    </div>
